...
#
# 한 번만 실행(채점용): python Total3/종합실습3_실행_스케줄러.py
# 지역별 리포트       : python Total3/종합실습3_실행_스케줄러.py --config region
# 경량 루프           : python Total3/종합실습3_실행_스케줄러.py --mode loop --interval 2 --count 3
# schedule 라이브러리 : python Total3/종합실습3_실행_스케줄러.py --mode schedule --interval 2 --count 2
# cron 등록용 한 줄   : python Total3/종합실습3_실행_스케줄러.py --mode cron
...
from 종합실습3_설정 import BY_REGION, DEFAULT
from 종합실습3_리포트생성 import generate_report
