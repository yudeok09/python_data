...
def gen_api_response() -> None:
    ...
    for uid in range(1, 41):
        rec = {
            ...
            "tags": random.sample(
                ["ai", "data", "web", "cloud", "mobile"], k=random.randint(0, 3)
            ),
        }
    ...
    with out.open("w", newline="", encoding="utf-8") as f:
        ...
        for i in range(n):
            ...
            w.writerow(
                [
                    f"ORD-{i:06d}",
                    (base + timedelta(days=random.randint(0, 120))).strftime(
                        "%Y-%m-%d"
                    ),
                    region,
...
def gen_events_large(n: int = 1_000_000) -> None:
    ...
    with out.open("w", newline="", encoding="utf-8") as f:
        ...
        for i in range(n):
            ...
            amount = (
                round(random.uniform(1_000, 500_000), 0)
            ...
            w.writerow(
                [
                    ...
                    et,
                    (base + timedelta(seconds=random.randint(0, 90 * 86400))).strftime(
                        "%Y-%m-%d %H:%M:%S"
                    ),
                    amount,
                ]
...
def gen_telco_churn(n: int = 7_000) -> None:
    ...
    with out.open("w", newline="", encoding="utf-8") as f:
        ...
        for i in range(n):
            ...
            total = (
                round(monthly * tenure * random.uniform(0.9, 1.1), 2) if tenure else 0.0
            )
